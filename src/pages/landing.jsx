        ...
        return (
            <>
                            ...
                            <ul>
                                <li data-index="rs-01" data-transition="fade" data-slotamount="default" data-easein="Power100.easeIn" data-easeout="Power100.easeOut" data-masterspeed="2000" data-fsmasterspeed="1500" data-param1="01">
                                    ...
                                    <div className="tp-caption tp-resizeme"
                                        ...
                                        <h1 className="text-white main-font font-weight-600 font-40"><span className="font-weight-200">Welcome to </span> <span style="color: #897b1c;">M O O N I</span>
                                        </h1>
                                    </div>
                                    <div className="tp-caption tp-resizeme"
                                        data-x="['right','center','center','center']" data-hoffset="['0','0','0','0']"
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-lg-6 wow fadeInLeft" data-wow-delay="300ms">
                                <p className="text-pink font-weight-200 font-20">Binance Smart Chain DeFi</p>
                                <h1 className="main-font font-weight-600 text-white">What is M O O N I?</h1>
                            </div>
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-12 col-lg-6 m-ipad wow fadeInRight" data-wow-delay="300ms">
                                    <div className="ml-md-4 pl-md-2 font-weight-200 text-grey font-18">
                                        <p className="text-pink font-weight-200 font-20">Power of M O O N I</p>
                                        <h1 className="main-font font-weight-600 text-white">Fair Launch!</h1>
                                        <p>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-lg-12 m-ipad wow fadeInRight" data-wow-delay="300ms">
                                <div className="ml-md-4 pl-md-2 font-weight-200 text-grey font-18">
                                    <h1 className="main-font text-pink  font-weight-600 text-white">
                                        Partner
                                    </h1>
                                    <p>
                ...
                <section className="p-0" id="roadmap">
                    <div className="row" style="background-color: #ddd;">
                        <div className="col-12" style="text-align: center;">
                            <img style="align-content: center;" src="moonitemplate/images/Roadmap.webp" alt="Roadmap" />
                        </div>
                    </div>
                    <div className="row">
